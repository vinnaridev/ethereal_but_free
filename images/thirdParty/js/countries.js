...
s_a[29] = "Acre|Alagoas|Amapá|Amazonas|Bahia|Ceará|Distrito Federal|Espírito Santo|Goiás|Maranhão|Mato Grosso|Mato Grosso do Sul|Minas Gerais|Pará|Paraíba|Paraná|Pernambuco|Piauí|Rio Grande do Norte|Rio Grande do Sul|Rio de Janeiro|Rondônia|Roraima|Santa Catarina|São Paulo|Sergipe|Tocantins";
...
s_a[43] = "Arica and Parinacota|Tarapacá|Antofagasta|Atacama|Coquimbo|Valparaíso|Santiago|O'Higgins|Maule|Ñuble|Biobío|Araucanía|Los Ríos|Los Lagos|Aysén|Magallanes";
...
s_a[100] = "Atlantida|Choluteca|Colon|Comayagua|Copan|Cortes|El Paraiso|Francisco Morazan|Gracias Dios|Intibuca|Islas de la Bahia|La Paz|Lempira|Ocotepeque|Olancho|Santa Barbara|Valle|Yoro";
s_a[101] = "Hong Kong";
...
s_a[125] = "Busan|Chungbuk|Chungnam|Daegu|Daejeon|Gangwon|Gwangju|Gyeongbuk|Gyeonggi|Gyeongnam|Incheon|Jeju|Jeonbuk|Jeonnam|Sejong|Seoul|Ulsan";
...
s_a[141] = "Johor|Kedah|Kelantan|Kuala Lumpur|Labuan|Melaka|Negeri Sembilan|Pahang|Penang|Perak|Perlis|Putrajaya|Sabah|Sarawak|Selangor|Terengganu";
...
s_a[150] = "Mayotte";
s_a[151] = "Aguascalientes|Baja California|Baja California Sur|Campeche|Chiapas|Chihuahua|Ciudad de México|Coahuila|Colima|Durango|Guanajuato|Guerrero|Hidalgo|Jalisco|México|Michoacán|Morelos|Nayarit|Nuevo León|Oaxaca|Puebla|Querétaro|Quintana Roo|San Luis Potosí|Sinaloa|Sonora|Tabasco|Tamaulipas|Tlaxcala|Veracruz|Yucatán|Zacatecas";
...
s_a[177] = "Bocas del Toro|Chiriquí|Coclé|Colón|Darién|Emberá|Herrera|Kuna Yala|Los Santos|Ngöbe-Buglé|Panamá|Panamá Oeste|Veraguas";
...
s_a[180] = "Amazonas|Áncash|Apurímac|Arequipa|Ayacucho|Cajamarca|Callao|Cuzco|Huancavelica|Huánuco|Ica|Junín|La Libertad|Lambayeque|Lima (departamento)|Lima (provincia)|Loreto|Madre de Dios|Moquegua|Pasco|Piura|Puno|San Martín|Tacna|Tumbes|Ucayali";
...
s_a[184] = "Açores|Aveiro|Beja|Braga|Bragança|Castelo Branco|Coimbra|Évora|Faro|Guarda|Leiria|Lisboa|Madeira|Portalegre|Porto|Santarém|Setúbal|Viana do Castelo|Vila Real|Viseu";
...
s_a[209] = "Eastern Cape|Free State|Gauteng|KwaZulu-Natal|Limpopo|Mpumalanga|North West|Northern Cape|Western Cape";
...
function populateStates(countryElementId, stateElementId) {
  ...
  stateElement.options[0] = new Option('Select State', 'null');
  ...
  // document.getElementById(stateElementId).value = new Option(' ', '-1');
}
